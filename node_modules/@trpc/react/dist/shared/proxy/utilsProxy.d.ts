...
import { TRPCContextProps, TRPCContextState, TRPCFetchInfiniteQueryOptions, TRPCFetchQueryOptions } from '../../internals/context';
...
export declare type DecoratedProcedureUtilsRecord<TRouter extends AnyRouter> = {
    [TKey in keyof Filter<TRouter['_def']['record'], AnyRouter | AnyQueryProcedure>]: TRouter['_def']['record'][TKey] extends AnyRouter ? DecoratedProcedureUtilsRecord<TRouter['_def']['record'][TKey]> : DecorateProcedure<TRouter, TRouter['_def']['record'][TKey]>;
};
export declare type CreateReactUtilsProxy<TRouter extends AnyRouter, TSSRContext> = DecoratedProcedureUtilsRecord<TRouter> & TRPCContextProps<TRouter, TSSRContext>;
/**
 * @internal
 */
